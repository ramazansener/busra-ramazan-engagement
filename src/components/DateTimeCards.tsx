  ...
  return (
    <section aria-labelledby="datetime-heading" className="space-y-3 sm:space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <FadeIn delay={0.08}>
          <article className="glass-card flex flex-col items-center justify-center rounded-2xl p-4 text-center shadow-xl sm:rounded-3xl sm:p-5">
            <span className="mb-2 flex h-9 w-9 items-center justify-center rounded-xl bg-sage/10 text-sage sm:h-10 sm:w-10 sm:rounded-2xl">
            ...
            <p className="mt-1.5 text-lg font-bold leading-tight text-ink sm:text-xl">
              1 Kasım
            </p>
        ...
        <FadeIn delay={0.16}>
          <article className="glass-card flex flex-col items-center justify-center rounded-2xl p-4 text-center shadow-xl sm:rounded-3xl sm:p-5">
            ...
            <p className="mt-1.5 text-lg font-bold leading-tight tabular-nums text-ink sm:text-xl">
              14:00 – 17:00
            </p>
